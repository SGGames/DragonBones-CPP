...
std::string assetDir = "F:/SGM/SGGAME/OpenSources/DragonBones/DragonBonesCPP/DemoAssets/Mecha/";
int main()
{
	...
	sf::Texture texture;
	texture.loadFromFile(assetDir+"mecha_1004d_tex.png");

	factory.loadDragonBonesData(assetDir+"mecha_1004d_ske.json");
	factory.loadTextureAtlasData(assetDir+"mecha_1004d_tex.json", &texture);
